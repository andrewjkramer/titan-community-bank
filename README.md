...
Upon completion of the semester, I took the time to learn how to connect the client-side code to the server-side code via API requests, and hosted it on Heroku... while also learning Bootstrap.
